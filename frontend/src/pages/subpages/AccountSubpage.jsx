            ...
            <div className={classes.mainContainer}>
                <div className={classes.emailContainer}>
                    ...
                    <div className={classes.bot}>
                        <p>
                            Clicking the button below will send a message to your current email with a secure link to
                            change your email
                        </p>
                ...
                <div className={classes.passwordContainer}>
                    ...
                    <div className={classes.bot}>
                        <p>
                            Clicking the button below will send a message to your current email with a secure link to
                            change your password. All passwords are encrypted in our database.
                        </p>
                        <Button onClick={() => {}} text={"Send Email Change Link"} />
                    </div>
                </div>
