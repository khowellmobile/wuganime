...
const ListsPage = () => {
    const { getUserAnimesByStatus, userAnime } = useUserAnime();
    const { showModal } = useModal();

    const [activeSort, setActiveSort] = useState("Recent");
    const [isAltActive, setIsAltAvtive] = useState(false);
    ...
    const sortOptions = [{ label: "Recent" }, { label: "Status" }, { label: "Date" }];
